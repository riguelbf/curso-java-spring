...
Adicionando configuração de repositório remoto: git remote add origin XXXXX (nome do repositorio)
Enviando as modificações para o diretório remoto: git push –u origin máster (nome da branch)
